-- Procedure: agg_pitching_split_stats
...
INSERT INTO agg_pitching_stats (
    ...
    doublePlays, triplePlays, groundOuts, hitBatsmen, hits, homeRuns,
    intentionalWalks, lineOuts, passedBalls, popOuts, runsBattedIn,
    sacBunts, sacFlies, singles, strikeOuts, triples, walks, wildPitches,
