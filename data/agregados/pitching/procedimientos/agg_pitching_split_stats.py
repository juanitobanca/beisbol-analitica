...
def generate_sql_file(output_path: str) -> None:
    header = """\
-- ============================================================
-- agg_pitching_split_stats cube — SQLite3 static equivalent
-- Generated by agg_pitching_split_stats_sqlite.py
-- Run with:  sqlite3 your_base.db < agg_pitching_split_stats.sql
-- ============================================================
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="agg_pitching_split_stats.sql",
