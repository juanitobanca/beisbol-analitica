# Lookups
## Overview
This directory contains lookup tables for MLB Stats API terminology.

- **lists** contains categorical lists
- **mappings** contains dictionary mappings of (typically) ids to names

## Useful Links
### MLB StatsAPI Docs  
 https://statsapi.mlb.com/docs/endpoints/attendance  
 https://statsapi.mlb.com/docs/endpoints/awards  
 https://statsapi.mlb.com/docs/endpoints/conference  
 https://statsapi.mlb.com/docs/endpoints/division  
 https://statsapi.mlb.com/docs/endpoints/draft  
 https://statsapi.mlb.com/docs/endpoints/game  
 https://statsapi.mlb.com/docs/endpoints/job  
 https://statsapi.mlb.com/docs/endpoints/league  
 https://statsapi.mlb.com/docs/endpoints/schedule  
 https://statsapi.mlb.com/docs/endpoints/season  
 https://statsapi.mlb.com/docs/endpoints/sports  
 https://statsapi.mlb.com/docs/endpoints/standings  
