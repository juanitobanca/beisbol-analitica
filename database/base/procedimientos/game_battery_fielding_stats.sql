...
SELECT
  ...
  -- FIX: cada base ahora usa su evento correcto
  CASE WHEN eventType = 'pickoff_caught_stealing_1b'   THEN 1 ELSE 0 END pickoffCaughtStealingFirstBase,
  CASE WHEN eventType = 'pickoff_caught_stealing_2b'   THEN 1 ELSE 0 END pickoffCaughtStealingSecondBase,
  CASE WHEN eventType = 'pickoff_caught_stealing_3b'   THEN 1 ELSE 0 END pickoffCaughtStealingThirdBase,
  CASE WHEN eventType IN ('pickoff_caught_stealing_1b', 'pickoff_caught_stealing_2b', 'pickoff_caught_stealing_3b', 'pickoff_caught_stealing_home') THEN 1 ELSE 0 END pickoffCaughtStealing,
